...
@section('title')
    <h3  class="card-title mt-2" style=" width:100%;">Edit User</h3>
@endsection
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header" style="margin-left:auto; width:100%;">
                                            <h3 class="card-title" style="width:100%;">Edit User</h3>
                                        </div>
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                                                    ...
                                                                    <div class="tab-pane {{$index == 0 ? 'active' : ''}}" id="{{$model}}">
                                                                        <div class="row">
                                                                            @foreach($maps as $key=>$map)
                                                                                <div class="col-md-3">
                                                                                    <label for=""> <input class="ml-2" type="checkbox" {{$user->hasPermission($map.'_'.$model) ? 'checked' : ''}} name="permissions[]" value="{{$map.'_'.$model}}">{{$map}}</label>
                                                                                </div>
                                                                            @endforeach
